package com.mlyndhg.luckdraw.configuration;

import com.mlyndhg.luckdraw.Interceptor.DemoInterceptor;
import com.mlyndhg.luckdraw.Interceptor.JWTInterceptor;
...
//                .maxAge(3600);
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(new JWTInterceptor()).addPathPatterns("/**")
                ...
                //拦截的路径
//                .addPathPatterns("/**")
//                .addPathPatterns("/getUserInfoById")
